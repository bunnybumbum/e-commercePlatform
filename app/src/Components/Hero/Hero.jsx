  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center items-start px-6 z-10">
        <h2 className="text-2xl md:text-3xl font-semibold text-white tracking-wide uppercase mb-4">
          Exclusive Arrivals
        </h2>
        <div className="mb-6">
          <p className="text-5xl md:text-6xl font-bold text-[#BF3131] drop-shadow-md transition-transform transform hover:scale-105">
            New
          </p>
          <p className="text-5xl md:text-6xl font-bold text-white drop-shadow-md transition-transform transform hover:scale-105">
            Collections
          </p>
          <p className="text-5xl md:text-6xl font-bold text-[#BF3131] drop-shadow-md transition-transform transform hover:scale-105">
            For Everyone
